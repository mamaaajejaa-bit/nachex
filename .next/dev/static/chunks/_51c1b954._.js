...
function VideoSection() {
    ...
    const [showButton, setShowButton] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [isMuted, setIsMuted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true) // Muted by default for autoplay
    ;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VideoSection.useEffect": ()=>{
            const autoplayTimer = setTimeout({
                "VideoSection.useEffect.autoplayTimer": ()=>{
                    if (videoRef.current) {
                        videoRef.current.play().then({
                            "VideoSection.useEffect.autoplayTimer": ()=>{
                                setIsPlaying(true);
                            }
                        }["VideoSection.useEffect.autoplayTimer"]).catch({
                            "VideoSection.useEffect.autoplayTimer": (error)=>{
            ...
            }["VideoSection.useEffect.autoplayTimer"], 500);
            return ({
                "VideoSection.useEffect": ()=>clearTimeout(autoplayTimer)
            })["VideoSection.useEffect"];
        }
    }["VideoSection.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s(VideoSection, "ABGpBwIarWM68kw4lRmM+zSQQWA=");
_c = VideoSection;
var _c;
...
function VideoTestimonial({ testimonial, isActive }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VideoTestimonial.useEffect": ()=>{
            if (!videoRef.current) return;
            if (isActive && !isPlaying) {
                videoRef.current.play().then({
                    "VideoTestimonial.useEffect": ()=>setIsPlaying(true)
                }["VideoTestimonial.useEffect"]).catch({
                    "VideoTestimonial.useEffect": ()=>{}
                }["VideoTestimonial.useEffect"]);
...
_s(VideoTestimonial, "gYnuxTGlO6L0sW8yeq/d/meTUGk=");
_c = VideoTestimonial;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Testimonials.useEffect": ()=>{
            ...
            const observers = videoRefs.current.map({
                "Testimonials.useEffect.observers": (videoDiv, index)=>{
                    if (!videoDiv) return null;
                    const observer = new IntersectionObserver({
                        "Testimonials.useEffect.observers": (entries)=>{
                            entries.forEach({
                                "Testimonials.useEffect.observers": (entry)=>{
                                    if (entry.isIntersecting && entry.intersectionRatio > 0.5) {
                                        setActiveVideoIndex(index);
                                    }
                                }
                            }["Testimonials.useEffect.observers"]);
                        }
                    }["Testimonials.useEffect.observers"], {
                        threshold: [
                            0.5
            ...
            return ({
                "Testimonials.useEffect": ()=>{
                    observers.forEach({
                        "Testimonials.useEffect": (observer)=>observer?.disconnect()
                    }["Testimonials.useEffect"]);
                }
            })["Testimonials.useEffect"];
        }
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: testimonials.map((testimonial, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(VideoTestimonial, {
...
_s1(Testimonials, "tncUYAl1acGcda4jMMiZehHma5s=");
_c1 = Testimonials;
var _c, _c1;
...
_s(FloatingCTA, "cQxHQteCMRoBIrVN2Pbt7rHdcyo=");
_c = FloatingCTA;
var _c;
...
//# sourceMappingURL=_51c1b954._.js.map