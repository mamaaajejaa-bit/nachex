...
export function HeroSection() {
  return (
    <section className="relative bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/5 via-background to-background overflow-hidden">
      <div className="bg-gradient-to-r from-primary to-primary/90 text-white py-2 px-4 text-center animate-in fade-in slide-in-from-top duration-500">
      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-6 pt-0 pb-0 text-center">
        {/* Logo mejorado con Glow */}
        <div className="-mb-12 -mt-6 relative animate-in fade-in zoom-in duration-700">
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100 fill-mode-backwards">
          <Badge className="relative overflow-hidden bg-primary/10 text-primary hover:bg-primary/20 mb-3 sm:mb-4 text-[10px] sm:text-xs py-1 px-2.5 sm:px-3 font-medium border border-primary/20 shadow-sm">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground leading-[1.1] sm:leading-tight mb-4 sm:mb-6 text-balance px-2 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 fill-mode-backwards">
          ...
          <span className="text-primary relative inline-block whitespace-nowrap">
            +50 pacientes
            <svg
              className="absolute -bottom-1 left-0 w-full h-1.5 sm:h-2 text-primary/50"
              viewBox="0 0 300 12"
              fill="none"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-xs sm:text-sm text-muted-foreground animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500 fill-mode-backwards">
          <div className="flex items-center gap-1.5 bg-white/60 backdrop-blur-sm rounded-full px-3 py-1.5 border border-primary/20 shadow-sm hover:shadow-md transition-all duration-300 hover:scale-105 cursor-default">
